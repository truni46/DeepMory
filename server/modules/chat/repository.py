...
class MessageRepository:
    ...
    async def get_byConversation(self, conversationId: str, limit: int = 100, offset: int = 0) -> List[Dict]:
    ...
    async def get_history_for_context(self, conversationId: str, limit: int = 10) -> List[Dict]:
        """Get recent messages formatted for LLM context"""
        messages = await self.get_byConversation(conversationId, limit)
